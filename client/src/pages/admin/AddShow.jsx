...
import { dummyShowsData } from '../../assets/assets'; // Dummy data
...
const AddShow = () => {
  ...
  const handleSubmit = () => {
    ...
    setDateTimeInput('');
    setAddingShow(false);
    alert('Show added successfully (mock)');
  };
    ...
    <>
      ...
      <div className="overflow-x-auto pb-4 no-scrollbar">
        <div className="group flex flex-wrap gap-4 mt-4 w-max">
          {nowPlayingMovies.map((movie) => (
            <div
              key={movie.id}
              onClick={() => setSelectedMovie(String(movie.id))}
      ...
      <button
        ...
        className={`bg-primary text-white px-8 py-2 mt-6 rounded transition-all cursor-pointer ${
          addingShow ? 'opacity-50 cursor-not-allowed' : 'hover:bg-primary/90'
        }`}
      >
